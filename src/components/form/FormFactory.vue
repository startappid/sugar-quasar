...
<div class="q-mt-md">
  <div class="row q-gutter-md" v-for="(fields, index) in layout" :key="`row-${index}`">
    <div :class="field.col" v-for="field in fields" :key="`form-${field.name}`">
      ...
      <div v-if="['FieldSteps'].indexOf(field.type) >= 0">
        <FieldSteps
          v-model="form[field.name]"
          :label="field.label"
          :readonly="readonly"
      ...
      <div v-if="['FieldShops'].indexOf(field.type) >= 0">
        <FieldShops
          v-model="form[field.name]"
          :label="field.label"
          :readonly="readonly"
      ...
      <div v-if="['FieldList'].indexOf(field.type) >= 0">
        <FieldList
          v-model="form[field.name]"
          :label="field.label"
          :readonly="readonly"
      ...
      <div v-if="['FieldTags'].indexOf(field.type) >= 0">
        <FieldTags
          v-model="form[field.name]"
          :label="field.label"
          :readonly="readonly"
      ...
      <div v-if="['FieldFileUploader'].indexOf(field.type) >= 0">
        <FieldFileUploader
          v-model="form[field.name]"
          :name="field.name"
          :label="field.label"
      ...
      <div v-if="['FieldOptionGroup'].indexOf(field.type) >= 0">
        <FieldOptionGroup
          v-model="form[field.name]"
          :name="field.name"
          :label="field.label"
...
import FieldSteps from 'components/forms/FieldSteps'
import FieldShops from 'components/forms/FieldShops'
import FieldList from 'components/forms/FieldList'
import FieldTags from 'components/forms/FieldTags'
import FieldOptionGroup from 'components/forms/FieldOptionGroup'
...
export default {
  ...
  methods: {
    ...
    ...mapMutations({
      ...
      resetValue: () => `${this.collection}/reset`
    }),
    ...mapActions({
