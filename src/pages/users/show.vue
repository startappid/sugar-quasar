<template>
  <q-page class="q-pa-md">
    ...
    <q-toolbar class="q-pb-md q-px-none" v-if="user?.role=='agent'">
      ...
      <q-btn flat icon="app_registration" class="q-ml-sm" label="Enrollments" :to="`/${collection}/${id}/enrollments?role=agent`" />
      <q-btn flat icon="card_membership" class="q-ml-sm" label="Memberships" :to="`/${collection}/${id}/memberships?role=agent`" />
      <q-btn flat icon="badge" class="q-ml-sm" label="Agents" :to="`/${collection}/${id}/agents?referral_id=${user.den_id}`" />
      <q-btn flat icon="school" class="q-ml-sm" label="Students" :to="`/${collection}/${id}/students?referral_id=${user.den_id}`" />
      <!--
      ...
      <q-btn flat round dense icon="more_vert">
        ...
        >
          <q-list>
            <q-item clickable v-close-popup :to="`/${collection}/${id}/identity`">
            ...
            <q-item clickable v-close-popup :to="`/${collection}/${id}/account`">
              <q-item-section avatar>
    ...
    <q-toolbar class="q-pb-md q-px-none" v-else-if="user?.role=='student'">
      ...
      <q-btn flat icon="app_registration" class="q-ml-sm" label="Enrollments" :to="`/${collection}/${id}/enrollments?role=student`" />
      <q-btn flat icon="card_membership" class="q-ml-sm" label="Tuitions" :to="`/${collection}/${id}/tuitions?role=student`" />
      <q-btn flat round dense icon="more_vert">
        <q-menu
          transition-show="jump-down"
          transition-hide="jump-up"
